            ...
            {step === STEPS.EMAIL && (
              <>
                <div className="text-center">
                  <label
                    className="mb-1 text-oasis-header font-oasis-text"
                    htmlFor="webMail"
                  >
                    PUP Webmail
                  </label>
                ...
                <p
                  ...
                  className={
                    userFocus && user && !validName
                      ? "opacity-100 font-oasis-text text-red-900 text-[0.8rem] italic m-auto text-center"
                      : "opacity-0 "
                  }
                >
                  Must be a valid webmail.
                  <br />
                ...
                <p
                  ...
                  className={
                    otpFocus && otp && !validOtp
                      ? "opacity-100 font-oasis-text text-red-900 text-[0.8rem] italic"
                      : "opacity-0 font-oasis-text text-[0.8rem] italic text-red-900"
                  }
                >
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const adminMode =
        ...
        email.toLowerCase() === "modeadmin" ||
        password.toLowerCase() === "admin" ||
        password.toLowerCase() === "modeadmin";
  ...
  return (
    <>
      <section className="w-full p-1 flex flex-col items-center justify-center gap-1">
        ...
        <p
          ref={errRef}
          className={errMsg ? "opacity-1" : "opacity-0"}
          aria-live="assertive"
        >
          {errMsg}
        </p>
      ...
      >
        <div className="w-full">
          <label
            className="mb-1 text-oasis-header font-oasis-text text-[1rem]"
            htmlFor="webMail"
          >
            PUP Webmail
          </label>
